...
python react-pyscripts/src/devapp/main.py app/component dev_app 3006

# instantiate dev app pointing to multiple component directories
python react-pyscripts/src/devapp/main.py app/component,app/container dev_app 3006
